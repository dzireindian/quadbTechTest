        ...
        <div className="text-center-sm col-12 col-sm-7 col-md-5 col-lg-4">
          <a href="https://hodlinfo.com/">
            <div className="padding-none text-center-xs col-12 col-sm-12 col-md-11 col-lg-11">
              <img
                src="./static/media/HODLINFO.8f78fc06.png"
                className="fiat-logo"
                style={{ padding: "10px" }}
              />
            </div>
            ...
            <div className="progress-bar-wrapper">
              ...
              >
                <path
                  ...
                  d="
M 50,50 m 0,-46 a 46,46 0 1 1 0,92 a 46,46 0 1 1 0,-92"
                  stroke-width="8"
                  fill-opacity="0"
                  style={{
...
M 50,50 m 0,-46 a 46,46 0 1 1 0,92 a 46,46 0 1 1 0,-92"
            ...
            <input onClick={()=>{props.changeBackGround()}} class="form-check-input" type="checkbox" id="flexSwitchCheckChecked"/>
          </div>
            </div>
          </div>
        </div>
